...
<body style="overflow: hidden;background-image: linear-gradient(to top left,rgb(222,54,114), rgb(253, 146, 34));width: 100%;height: 1500px">
    
    <div style="margin: 150px auto;width: 1200px;border-radius: 20px;display: grid; grid-auto-flow: column; justify-content: end;background-image: linear-gradient(to bottom right,rgb(222,54,114), rgb(253, 146, 34));">
        ...
        <div style="width:700px;background-color:white;border-radius: 20px;">
            <div style="padding: 100px 40px 100px 120px;position: relative;">
                ...
                <table>
                    <h1 style="font-size: 70px;margin-bottom: 50px;">Đăng nhập</h1>
                    <form action="controller/controller.php" method="POST" role="form">
                        ...
                        <div style="margin-top: 20px;">
                            <input type="submit" value="Đăng Nhập" name="login" style="border: none;border-radius: 5px;font-size: 30px;width: 100%;background-color: rgb(253, 146, 34);color: white;font-family: 'Oswald', sans-serif;font-weight: 600;height: 50px;">
                        </div>
                        <div style="margin-top: 20px;">
                            <p>Chưa có tài khoản? Đăng ký <a href="register.php" style="text-decoration: underline;">tại đây.</a></p>
                        </div>
